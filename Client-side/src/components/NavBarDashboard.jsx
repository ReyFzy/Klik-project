...
const NavBarDashboard = () => {
    ...
    const userName = getUserId("1");
    return (
        <div className="navbar bg-neutral-50 h-fit w-full rounded-lg mt-2 text-primary px-3">
            <div className="flex-1">
                <div className="form-control">
                    <input 
                    type="text" 
                    placeholder="Search" 
                    className="input input-sm focus:input-primary input-bordered text-black placeholder:text-neutral-600 bg-neutral-200 w-24 md:w-auto" 
                    />
                </div>
            </div>
            <p>Hello, {userName} </p>
            <div className="flex gap-2">
                <div className="dropdown dropdown-end">
                    ...
                    <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-primary rounded-box w-52 text-white">
                        <li className="px-4 text-sm text-center">YOUR NOTIFICATION WILL DISPLAY HERE</li>
                    </ul>
                </div>
